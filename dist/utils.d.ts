 ...
 */
export declare function setEdgeBorder(arr: [number, number, number, number], edge: number, value: number): void;
/**
 ...
 */
export declare function getEdgeBorderValue(arr: [number, number, number, number], edge: number): number;
/**
